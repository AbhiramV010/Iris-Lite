        ...
        try:
            with l.accept() as conn:
                ...
                if capture:
                    ...
                    threading.Thread(target=save_clip_worker, args=(buffer_snapshot, capture.trigger, capture), daemon=True).start()
        except: continue
...
if __name__ == "__main__":
    ...
    ret, frame = cam.read()
    small_prev = cv2.resize(cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY), (320, 180))
